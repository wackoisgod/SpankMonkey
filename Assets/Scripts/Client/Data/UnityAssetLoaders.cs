...
public class AsyncSceneLoader : AssetLoadRequest
{
...
public class AssetBundleLoader : AssetLoadRequest
{
...
public class BulkAssetBundleLoader : AssetLoadRequest
{
	public bool DeferredRelease;
		...
		else
		{
			...
			else
			{
				...
				for (int i = 0; i < bundleData.dependencies.Length; i++)
				{
					...
					assetLoader.OnCompleteLoading += asset =>
					{
						if (asset is BulkAssetBundleLoader)
						{
							var bulkAssetBundleLoader = asset as BulkAssetBundleLoader;
						...
						if (--dependencyCount == 0)
						{
							if (asset is BulkAssetBundleLoader)
							{
								var assetBundleLoader = asset as BulkAssetBundleLoader;
...
public class AsyncWebLoader : AssetLoadRequest
{
...
public class AsyncPollingWebLoader : AssetLoadRequest
{
	public string Url { get; set; }
	public byte[] WebData { get; set; }
	public Dictionary<string, string> Headers { get; set; }
...
public class AsyncPostWebLoader : AssetLoadRequest
{
	public string Url { get; set; }
	public byte[] WebData { get; set; }
